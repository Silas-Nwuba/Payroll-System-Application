...
namespace Enterprise.Persistence.Migrations
{
    ...
    [Migration("20220324142119_ChangeInPostCodeFromIntToString")]
    partial class ChangeInPostCodeFromIntToString
    {
            ...
            modelBuilder.Entity("Enterprise.Entity.Employee", b =>
                {
                    ...
                    b.Property<int>("StudentLoanPayment")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Enterprise.Entity.PaymentRecord", b =>
                {
                    ...
                    b.Property<decimal>("ContratualEarning")
                        .HasColumnType("Money");

                    b.Property<decimal>("ContratualHour")
                    ...
                    b.HasIndex("TaskYearId");

                    b.ToTable("PaymentRecords");
                });

            modelBuilder.Entity("Enterprise.Entity.TaskYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Enterprise.Entity.PaymentRecord", b =>
                {
                    ...
                    b.HasOne("Enterprise.Entity.TaskYear", "TaskYear")
                        .WithMany()
                        .HasForeignKey("TaskYearId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
