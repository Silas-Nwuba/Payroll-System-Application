        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NationalInsuranceNumber = table.Column<string>(maxLength: 100, nullable: false),
                    Address = table.Column<string>(maxLength: 150, nullable: false),
                    City = table.Column<string>(maxLength: 100, nullable: false),
                    PostCode = table.Column<int>(maxLength: 100, nullable: false),
                    ImageUrl = table.Column<string>(nullable: true),
                    PaymentMethod = table.Column<int>(nullable: false),
                    UnionMember = table.Column<int>(nullable: false),
                    StudentLoanPayment = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskYears", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMonth = table.Column<DateTime>(nullable: false),
                    TaskYearId = table.Column<int>(nullable: false),
                    ...
                    ContratualHour = table.Column<decimal>(type: "Decimal(18,2)", nullable: false),
                    OvertimeHour = table.Column<decimal>(type: "Decimal(18,2)", nullable: false),
                    ContratualEarning = table.Column<decimal>(type: "Money", nullable: false),
                    ...
                    NLC = table.Column<decimal>(type: "Money", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentRecords_TaskYears_TaskYearId",
                        column: x => x.TaskYearId,
                        principalTable: "TaskYears",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_TaskYearId",
                table: "PaymentRecords",
                column: "TaskYearId");
        }
